    ...
    for (field in mappingData.properties) {
      if (mappingData.properties.hasOwnProperty(field)) {
        if (object[field] !== undefined) {
          if (mappingData.properties[field].cast) {
            val = mappingData.properties[field].cast(object[field], {document: main, container: object, field: field});
          } else {
            val = serialize.call(object, object[field], mappingData.properties[field], main);
          }
          if (val !== undefined) {
